...
// Обратите внимание на импорт scss файла со стилями для задач. // Мы оставили
его в отдельном файле, так как позже у задач будет отдельный компонент. //
@import — синтаксис импорта в scss // Знак тильды "~" — это символ, который
указывает на то, // что следующее за ним значение будет alias. // Знак "@" — это
алиас из webpack, который мы используем для замены на "src" // В результате
стили будут импортированы из "src/assets/..."
